...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between px-4 md:px-36 md:pt-30 pt-20 text-left">
                    ...
                    <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300">
                      {chapter.chapterContent.map((lecture, index) => (
                        <li key={index} className="flex items-start gap-2 py-1">
                          ...
                          />
                          <div className="flex items-center justify-between w-full text-gray-800 md: text-base">
        ...
        {/* right column */}
        <div className="max-w-3 z-10 drop-shadow-lg rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          {playerData ? (
            <YouTube
          ...
          <div className="p-5">
            ...
            <div className="flex gap-3 items-center pt-2">
              <p className="text-gray-800 md:text-xl text-2xl font-bold">
                ${currency}
                {(
